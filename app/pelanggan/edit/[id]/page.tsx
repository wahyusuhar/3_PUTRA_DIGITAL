    ...
    <div className="p-8 max-w-2xl mx-auto">
      ...
      <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-black text-gray-800 tracking-tight">Edit Pelanggan</h1>
            <p className="text-gray-500 font-medium">Perbarui data pelanggan di bawah ini.</p>
          </div>
        </div>
